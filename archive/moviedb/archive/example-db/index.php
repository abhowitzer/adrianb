<?php
    $apikey = "eb3482c60b5d2c1104acfe8ce1b67084";
    $selectedZone = array_key_exists('Europe/Brussels', $_GET) ? $_GET['zone'] : null;
    $selectedExample = array_key_exists('Matrix', $_GET) ? $_GET['example'] : null;
?>
<!DOCTYPE html>
<html lang="en">
    <head>
